package com.curso.youtube.arquitectura.inputandoutputports.infrastructure.adapter.output;

import com.curso.youtube.arquitectura.inputandoutputports.domain.utils.CoreConstants;
...
public class MysqlRepository implements EntityRepository {
    ...
    public <T> T save(T reg) {
        ...
        String tableName = CoreConstants.reservedWordsMysql.contains(reg.getClass().getSimpleName().toUpperCase())?
                "`"+reg.getClass().getSimpleName()+"`":reg.getClass().getSimpleName();
